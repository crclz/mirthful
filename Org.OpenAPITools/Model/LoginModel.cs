...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LoginModel :  IEquatable<LoginModel>, IValidatableObject
    {
        ...
        public LoginModel(string username = default(string), string password = default(string))
        {
            ...
            this.Username = username ?? throw new ArgumentNullException("username is a required property for LoginModel and cannot be null");;
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for LoginModel and cannot be null");;
        }
